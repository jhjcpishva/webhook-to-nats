...
MESSENGER_NATS_SUBJECT_PREFIX = os.getenv("MESSENGER_NATS_SUBJECT_PREFIX", "webhook.messenger")
...
LINE_NATS_SUBJECT_PREFIX = os.getenv("LINE_NATS_SUBJECT_PREFIX", "webhook.line")
